...
// index.ts (standalone/central server) and desktop.ts (sidecar) -- run once
// at boot, log the count, never fatal. Not env-mode-only: a `sessions` row
// can be left 'running' after any process restart regardless of auth mode
