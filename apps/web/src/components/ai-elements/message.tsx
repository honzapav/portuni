...
//
// Adapted from AI Elements (https://elements.ai-sdk.dev) `message`, pulled
// via `npx ai-elements@latest add message` (ai-elements@1.9.0). Changed:
// `MessageProps.from` is our own `MessageRole` union instead of
